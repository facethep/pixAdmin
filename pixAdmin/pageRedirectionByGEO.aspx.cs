...
namespace pixAdmin
{
    public partial class pageRedirectionByGEO : System.Web.UI.Page
    {
        ...
        private void BindPages()
        {
            ...
            var result = db.Query<pixPageRedirectionByGEO>(sQuery);
        ...
        protected void grdPageRedirect_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            pixPageRedirectionByGEO lPage = new pixPageRedirectionByGEO();
        ...
        protected void updateRedirect(object sender, GridViewUpdateEventArgs e)
        {
            ...
            lPage.countryCode = txtCountryCode.Text;
        ...
        {
            pixPageRedirectionByGEO pageRedirect = new pixPageRedirectionByGEO();
            ...
            pageRedirect.countryCode = txtCountryCode.Text;
