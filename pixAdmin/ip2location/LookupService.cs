...
public class LookupService{
  ...
  "Saint Barthelemy","Saint Martin", "Bonaire, Saint Eustatius and Saba", "South Sudan", "Other"};
    ...
    public LookupService(String databaseFile, int options){
        lock ( ioLock ) {
                   /*if (System.Web.HttpContext.Current.Application.Get("myFileStream") == null)
                    {
                        FileStream s = new FileStream(databaseFile, FileMode.Open, FileAccess.Read);
                        System.Web.HttpContext.Current.Application["myFileStream"] = s;
                    }

                    this.file = (FileStream)System.Web.HttpContext.Current.Application.Get("myFileStream");// new FileStream(databaseFile, FileMode.Open, FileAccess.Read);
                  */ 
